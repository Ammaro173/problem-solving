const { customerAndAge, getEntries, courses, getInfo, getStudents } = require('./Challenge08');
...
describe('Challenge08-01', () => {
  test('Customer-and-average', () => {
    ...
    expect(customerAndAge(names)[0]).toStrictEqual('Customer Name :Romio Joliat , Age :35');
  });
});
...
describe('Challenge08-02', () => {
  test('Get-recipe-key', () => {
    ...
    expect(getEntries(recipeInfo)).toStrictEqual(['name: pizza', 'ingredients: bread,tomato,chicken,mayo', 'cookTime: twoHours', 'price: 25$']);
  });
});
