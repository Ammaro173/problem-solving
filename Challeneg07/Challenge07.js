...
const objLat = (obj) => {
  return `my name is ${
    obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1) // only mark Has m small :D || can`t use splicce!
...
//   this.hobby = hobby;
//   bs.push(this);
//   return `my name is ${objLat[0]} ${objLat[1]} I am ${objLat[2]} YO, and I
//     love ${objLat[3]}`;
// };
